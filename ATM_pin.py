...
details_frame = Frame(master=root, height=150, width=360, bg="#d0efff")

name_label = Label(details_frame, text="Account Name", bg="#3895D3", fg="white", width=14)
pin_label = Label(details_frame, text="Create PIN", bg="#3895D3", fg="white", width=14)
...
for i in range(4):
    ...
    for j in range(3):
        ...
        number_label = Label(master=cell, text=numbers[i][j], bg="#d0efff")
        number_label.pack(padx=8, pady=8)

confirm_button = Button(root, text="Set ATM PIN", command=confirm_pin, bg="red", fg="white")
message_box = Text(root, height=5, width=42, bg="#BEBEBE", fg="black")
